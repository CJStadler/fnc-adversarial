...
def write_csvs(transformed_examples):
    t = round(time())
    with open('data/{}baseline_bodies.csv'.format(t), 'w',encoding='utf-8-sig') as csvfile:
    ...
    with open('data/{}baseline_stances.csv'.format(t), 'w',encoding='utf-8-sig') as csvfile:
    ...
    with open('data/{}baseline_changes.csv'.format(t), 'w',encoding='utf-8-sig') as csvfile:
